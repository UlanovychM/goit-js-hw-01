...
function getElementWidth(content, padding, border) {
	const contentNum = getStrToNum(content);
	const paddingNum = getStrToNum(padding);
	const borderNum = getStrToNum(border);
	return contentNum + (paddingNum + borderNum) * 2;
}
